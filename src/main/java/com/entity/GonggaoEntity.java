...
public class GonggaoEntity<T> implements Serializable {
     ...
     * 宿舍公告名称
     */
    @ColumnInfo(comment="宿舍公告名称",type="varchar(200)")
     ...
     * 宿舍公告图片
     */
    @ColumnInfo(comment="宿舍公告图片",type="varchar(200)")
     ...
     * 宿舍公告类型
     */
    @ColumnInfo(comment="宿舍公告类型",type="int(11)")
	...
	@DateTimeFormat
    @ColumnInfo(comment="宿舍公告发布时间",type="timestamp")
     ...
     * 宿舍公告详情
     */
    @ColumnInfo(comment="宿舍公告详情",type="longtext")
