...
public class NewsEntity<T> implements Serializable {
     ...
     * 校园资讯名称
     */
    @ColumnInfo(comment="校园资讯名称",type="varchar(200)")
     ...
     * 校园资讯图片
     */
    @ColumnInfo(comment="校园资讯图片",type="varchar(200)")
     ...
     * 校园资讯类型
     */
    @ColumnInfo(comment="校园资讯类型",type="int(11)")
	...
	@DateTimeFormat
    @ColumnInfo(comment="校园资讯发布时间",type="timestamp")
     ...
     * 校园资讯详情
     */
    @ColumnInfo(comment="校园资讯详情",type="longtext")
