	...
	*/
	...
	//级联表 学生
		...
		*/
		...
		private String shoumairenName;

		private String shoumairenPhone;


	public String getShoumairenName() {
		return shoumairenName;
	}

	public void setShoumairenName(String shoumairenName) {
		this.shoumairenName = shoumairenName;
	}

	public String getShoumairenPhone() {
		return shoumairenPhone;
	}

	public void setShoumairenPhone(String shoumairenPhone) {
		this.shoumairenPhone = shoumairenPhone;
	}
