    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(shangpinCommentback !=null){
            ...
            //级联表 学生
            //级联表
            XueshengEntity xuesheng = xueshengService.selectById(shangpinCommentback.getXueshengId());
            if(xuesheng != null){
    ...
    */
    ...
    public R save(@RequestBody ShangpinCommentbackEntity shangpinCommentback, HttpServletRequest request){
        ...
        if(false)
            ...
            shangpinCommentback.setXueshengId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
...
//                            shangpinCommentbackEntity.setXueshengId(Integer.valueOf(data.get(0)));   //学生 要改的
