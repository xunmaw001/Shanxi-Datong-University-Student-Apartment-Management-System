    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(shangpin !=null){
            ...
            //级联表 学生
            //级联表
            XueshengEntity xuesheng = xueshengService.selectById(shangpin.getXueshengId());
            if(xuesheng != null){
    ...
    */
    ...
    public R save(@RequestBody ShangpinEntity shangpin, HttpServletRequest request){
        ...
        if(false)
            ...
            shangpin.setXueshengId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));

        Wrapper<ShangpinEntity> queryWrapper = new EntityWrapper<ShangpinEntity>()
            .eq("xuesheng_id", shangpin.getXueshengId())
                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            ShangpinEntity shangpinEntity = new ShangpinEntity();
//                            shangpinEntity.setXueshengId(Integer.valueOf(data.get(0)));   //学生 要改的
...
//                            shangpinEntity.setShangpinAddress(data.get(0));                    //交易位置 要改的
