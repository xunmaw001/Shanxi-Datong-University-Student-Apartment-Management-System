    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(shangpinCollection !=null){
            ...
            //级联表 学生
            //级联表
            XueshengEntity xuesheng = xueshengService.selectById(shangpinCollection.getXueshengId());
            if(xuesheng != null){
    ...
    */
    ...
    public R save(@RequestBody ShangpinCollectionEntity shangpinCollection, HttpServletRequest request){
        ...
        if(false)
            ...
            shangpinCollection.setXueshengId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<ShangpinCollectionEntity> queryWrapper = new EntityWrapper<ShangpinCollectionEntity>()
            ...
            .eq("xuesheng_id", shangpinCollection.getXueshengId())
...
//                            shangpinCollectionEntity.setShangpinId(Integer.valueOf(data.get(0)));   //二手商品 要改的
//                            shangpinCollectionEntity.setXueshengId(Integer.valueOf(data.get(0)));   //学生 要改的
