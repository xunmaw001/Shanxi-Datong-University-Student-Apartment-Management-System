<template>
    <div class="main-content">
        ...
        <div v-if="showFlag">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/daxueshenggongyuguanli/upload/shangpinOrderMuBan.xls"
                        >批量导入二手商品订单数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('shangpinOrder','导入导出')"
            ...
            <el-button v-if="isAuth('shangpinOrder','订单') && scope.row.shangpinOrderTypes == 101 && sessionTable=='xuesheng' && userId==scope.row.xueshengId" type="primary" icon="el-icon-sold-out" size="mini" @click="refund(scope.row.id)">退款</el-button>
            <el-button v-if="isAuth('shangpinOrder','订单') && scope.row.shangpinOrderTypes == 104 && sessionTable=='xuesheng' && userId==scope.row.xueshengId" type="primary" icon="el-icon-reading" size="mini" @click="openCommentModel(scope.row.id)">评价</el-button>
            <el-button v-if="isAuth('shangpinOrder','订单') && scope.row.shangpinOrderTypes == 101
&& sessionTable=='xuesheng' && userId==scope.row.shangpinXueshengId" type="primary" icon="el-icon-reading" size="mini"
                        @click="deliver(scope.row.id)"
            >发货</el-button>
            <el-button v-if="isAuth('shangpinOrder','订单') && scope.row.shangpinOrderTypes == 103 && sessionTable=='xuesheng' && userId==scope.row.xueshengId" type="primary" icon="el-icon-reading" size="mini" @click="receiving(scope.row.id)">收货</el-button>
