                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/daxueshenggongyuguanli/upload/suguanMuBan.xls"
                        >批量导入宿管数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('suguan','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   ...
                                   label="宿管身份证号">
                        <template slot-scope="scope">
                            {{scope.row.suguanIdNumber}}
                        </template>
                    </el-table-column>
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="suguanPhoto"
                                     header-align="center"
                                     width="200"
                                     label="宿管头像">
                        <template slot-scope="scope">
                            <div v-if="scope.row.suguanPhoto">
                                <img :src="$base.url+scope.row.suguanPhoto" width="100" height="100">
                            </div>
                            <div v-else>无图片</div>
                        </template>
                    </el-table-column>
        ...
        methods: {
            chartDialog() {
                ...
                let params = {
                    ...
                    thisTable : {//当前表
                        tableName :'suguan',//当前表表名,
                        sumColum : 'suguan_number', //求和字段
                        date : 'insert_time',//分组日期字段
                        // string : 'suguan_name',//分组字符串字段
                        // types : 'suguan_types',//分组下拉框字段
                    },
                    // joinTable : {//级联表（可以不存在）
