    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="xueshengId" name="xueshengId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="交易位置" prop="shangpinAddress">
                       <el-input v-model="ruleForm.shangpinAddress"
                                 placeholder="交易位置" clearable  :readonly="ro.shangpinAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="交易位置" prop="shangpinAddress">
                           <el-input v-model="ruleForm.shangpinAddress"
                                     placeholder="交易位置" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   shangpinAddress: [
                              { required: true, message: '交易位置不能为空', trigger: 'blur' },
                          ],
                   shangpinTypes: [
