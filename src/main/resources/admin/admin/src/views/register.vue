    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">学生公寓管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <el-form-item label="宿管身份证号" class="input" v-if="tableName=='suguan'">
                            <el-input v-model="ruleForm.suguanIdNumber" autocomplete="off" placeholder="宿管身份证号"  />
                        </el-form-item>
                        <!--
                            <el-form-item v-if="suguanPhotoFlag">
                            </el-form-item>
                            <el-form-item label="宿管头像" class="input" v-if="tableName=='suguan'">
                                    <file-upload
                                        tip="点击上传宿管头像"
                                        action="file/upload"
                                        :limit="1"
                                        :multiple="true"
                                        :fileUrls="ruleForm.suguanPhoto?$base.url+ruleForm.suguanPhoto:''"
                                        @change="suguanPhotoUploadChange"
                                    ></file-upload>
                           </el-form-item>
                        -->
                        <el-form-item label="宿管邮箱" class="input" v-if="tableName=='suguan'">
                            <el-input v-model="ruleForm.suguanEmail" autocomplete="off" placeholder="宿管邮箱"  />
                        </el-form-item>
                        <!--
                            <el-form-item label="创建时间" class="input" v-if="tableName=='suguan'">
                        ...
                        -->
                        <!--
                            <el-form-item label="余额" class="input" v-if="tableName=='xuesheng'">
    ...
    export default {
        data() {
            return {
                ...
                rules: {},
                sexTypesOptions : [],
                suguanPhotoFlag:false,//用于刷新文件上传
        ...
        methods: {
            ...
            suguanPhotoUploadChange(fileUrls) {
               this.ruleForm.suguanPhoto = fileUrls;
                if(this.suguanPhotoFlag){
                    this.suguanPhotoFlag=false;
                }else{
                    this.suguanPhotoFlag=true;
                }
            },
            ...
            login() {
                            ...
                            if((!this.ruleForm.suguanName)&& 'suguan'==this.tableName){
                            ...
                            if((!this.ruleForm.suguanIdNumber)&& 'suguan'==this.tableName){
                                this.$message.error('宿管身份证号不能为空');
                                return
                            }
                            // suguan 中的 宿管头像 判空处理
                            // if('suguan' == this.tableName && (this.ruleForm.suguanPhoto== null ||this.ruleForm.suguanPhoto== "")){
                            //     this.$message.error("宿管头像不能为空");
                            //     return
                            // }
                            ...
                            // suguan 中的 创建时间 判空处理
                            // if('suguan' == this.tableName && (this.ruleForm.createTime== null ||this.ruleForm.createTime== "")){
                            ...
                            // }
                            // xuesheng 中的 余额 判空处理
                            // if('xuesheng' == this.tableName && (this.ruleForm.newMoney== null ||this.ruleForm.newMoney== "")){
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/daxueshenggongyuguanli/img/back-img-bg.jpg);
